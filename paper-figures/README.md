...
> [`../README.md`](../README.md).
>
> Run it from this directory: it reads `kripke_example.json` and writes its
> `.dot` and `.png` output relative to the working directory. It needs Spot and
> Graphviz; `python -m strategy_monitor dot` emits the same automata without
> either.
